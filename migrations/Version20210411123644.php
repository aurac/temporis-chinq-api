 ...
 */
final class Version20210411123644 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD updated_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DA88B137896DBBDE');
        $this->addSql('ALTER TABLE recipe DROP updated_by_id');
    }
}
